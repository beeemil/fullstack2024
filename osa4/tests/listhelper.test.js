...
describe('total likes', () => {
    ...
    test('when list has six blogs equals the sum of likes of them', () => {
...
describe('favorite blog', () => {
  test('equals to canonical string reduction for list of six blogs', () => {
